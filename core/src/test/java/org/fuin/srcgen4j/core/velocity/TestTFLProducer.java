...
public final class TestTFLProducer implements TargetFileListProducer {
    ...
    public final List<TargetFile> createTargetFiles() {
        ...
        files.add(new TargetFile("current", "testJava", "a", "A2.java", new Argument("name", "A2"), new Argument("pkg", "a")));
        files.add(new TargetFile("current", "testJava", "b", "B2.java", new Argument("name", "B2"), new Argument("pkg", "b")));
        return files;
    }
